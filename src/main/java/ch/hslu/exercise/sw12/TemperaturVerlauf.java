...
public class TemperaturVerlauf implements ITemperaturVerlauf {
    ...
    public Temperatur max(){
        ...
        return temperaturen.stream().max(Temperatur::compareTo).orElse(null);
    }
    ...
    public Temperatur min(){
        ...
        return temperaturen.stream().min(Temperatur::compareTo).orElse(null);
    }
    ...
    public Temperatur getTemperatur(final int index){
        return temperaturen.stream().filter(t -> t.equals(index)).findFirst().orElse(null);
    }
